...
export default {
    ...
    {index: 6, label: '信息平台', url: '/apps/knowEverything/information', labelIcon: 'UploadCloudIcon', highlightAction: true},
    {index: 7, label: '管理信息', url: '/apps/knowEverything/informationManage', labelIcon: 'ShieldIcon', highlightAction: true},
    {index: 8, label: '新闻', url: '/apps/news', labelIcon: 'FileTextIcon', highlightAction: false},
		...
		{index: 10, label: '博客管理', url: '/pages/BlogManagement', labelIcon: 'CreditCardIcon', highlightAction: false},

		{index: 11, label: '个人中心', url: '/pages/profile', labelIcon: 'UserIcon', highlightAction: false},
	]
}
